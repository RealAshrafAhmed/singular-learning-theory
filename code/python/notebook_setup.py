...
def setup_environment():
    ...
    if not is_colab_environment():
        print("Running in local Jupyter environment. Assuming data and dependencies are available.")
    ...
    if Path(REQUIREMENTS_FILE).is_file():
        ...
        try:
            ...
            subprocess.run([sys.executable, "-m", "pip", "install", "-r", REQUIREMENTS_FILE, "-q"], check=True)
